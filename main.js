...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export     = __webpack_require__(30)
	  ...
	  , toLength    = __webpack_require__(59)
	  , isRegExp    = __webpack_require__(156)
	  , getFlags    = __webpack_require__(218)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(28) && $export($export.P + __webpack_require__(284), 'Object', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Set                     = __webpack_require__(236)
	  , from                    = __webpack_require__(290)
	  , metadata                = __webpack_require__(299)
	  , anObject                = __webpack_require__(34)
	  , getPrototypeOf          = __webpack_require__(81)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var path      = __webpack_require__(312)
	  , invoke    = __webpack_require__(100)
	  , aFunction = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "cfa87e8c31563cbf1d88f0a7120f8bba.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ui_actions = __webpack_require__(340);
	
	var ui = _interopRequireWildcard(_ui_actions);
	
	var _markerContent = __webpack_require__(341);
	...
	var defaultLocation = { lat: 37.783014, lng: -122.4027028 };
	var defaultReservationDuration = 30; // minutes
	
	var map = void 0; // Reference to the Google Maps instance on the page
	
	function refreshMap() {
		api.retrieveParking(defaultLocation, function (data) {
			var isAvailable = function isAvailable(location) {
				return new Date(location.reserved_until) < new Date();
			};
			var locations = data.filter(isAvailable).map(function (location) {
				return {
					position: {
			...
			locations.forEach(function (location) {
				var content = _markerContent2.default.replace("{{id}}", location.id).replace("{{name}}", location.name).replace("{{address}}", "Loading address...").replace("{{spots_number}}", "Unknown").replace("{{cost}}", location.cost).replace("{{distance}}", "Calculating...");
	 ...
	 */
	window.onMapMarkerPayReserveClick = function (element) {
		var locationId = element.dataset.locationId;
		var duration = defaultReservationDuration;
		var oldLabel = element.innerHTML;
		element.innerHTML = "Processing...";
		api.reserveParking(locationId, duration, function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.retrieveParking = retrieveParking;
	exports.reserveParking = reserveParking;
	
	var _superagent = __webpack_require__(335);
	
	var _superagent2 = _interopRequireDefault(_superagent);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var listUrl = "http://ridecellparking.herokuapp.com/api/v1/parkinglocations/search?lat={{lat}}&lng={{lng}}";
	var reserveUrl = "http://ridecellparking.herokuapp.com/api/v1/parkinglocations/{{id}}/reserve/";
	
	function retrieveParking(_ref, success, fail, finish) {
		var lat = _ref.lat;
		var lng = _ref.lng;
	
		var url = listUrl.replace("{{lat}}", lat).replace("{{lng}}", lng);
	...
	function reserveParking(id, duration, success, fail, finish) {
		var url = reserveUrl.replace("{{id}}", id);
	
		_superagent2.default.post(url).send({ minutes: duration }).end(function (err, res) {
			if (!err && res) {
				success && success(res.body);
			} else {
				fail && fail(err, res);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(336);
	var requestBase = __webpack_require__(337);
	...
	var request = module.exports = __webpack_require__(339).bind(null, Request);
...
/***/ function(module, exports) {
	...
	exports.openSuccessDialog = openSuccessDialog;
	exports.closeSuccessDialog = closeSuccessDialog;
	...
	function hideDialogs() {
		var successEl = document.getElementById("success-dialog");
		var errorEl = document.getElementById("error-dialog");
	...
	function openSuccessDialog() {
		...
		var containerEl = document.getElementById("dialogs-container");
	...
	document.getElementById("dialogs-container").onclick = function () {
		closeSuccessDialog();
		closeErrorDialog();
	};
